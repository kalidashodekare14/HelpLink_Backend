    ...
    bikashPayment: async (paymentInfo) => {
        try {
            ...
            const createPayment = await axios_1.default.post(env_1.config.bkash_create_payment_url, {
                mode: "0011",
                payerReference: " ",
                callbackURL: `${env_1.config.backend_url}/api/v1/donor/bikash_payment_callback`,
    ...
    sllcommerzPayment: async (paymentInfo) => {
        try {
            ...
            const initateData = {
                ...
                currency: "BDT",
                tran_id: tnxId,
                success_url: `${env_1.config.backend_url}/api/v1/donor/sslcommerz_payment_success`,
                fail_url: `${env_1.config.backend_url}/api/v1/donor/sslcommerz_payment_fail`,
                cancel_url: `${env_1.config.backend_url}/api/v1/donor/sslcommerz_payment_cancel`,
